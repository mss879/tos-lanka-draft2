...
export default function CertificationPage() {
  ...
  const awards = [
    { title: "Presidential Export Award", desc: "Best Exporter for Electrical and Electronic Sector", year: "2010, 2011", image: "Presudental export award.webp" },
    { title: "Global Commerce Excellence", desc: "Recipient of the celebrated Global Commerce Award.", year: "2012", image: "Global Commerce Excellence.webp" },
    { title: "National Exporters Award", desc: "Recipient of the National Exporters Award.", year: "2015", image: "NCE Export Award.webp" },
    { title: "Service Sector Merit", desc: "Recognized with the Service Sector Medium Scale Merit Award.", year: "2014", image: "service sector medium scale merit award.webp" },
    { title: "Social Dialogue Excellence", desc: "Awarded for exceptional Workplace Co-operation.", year: "2014", image: "social dialogue & wordplace co-operation award 2014.webp" },
    { title: "National Productivity Award", desc: "Recognized for outstanding manufacturing productivity.", year: "2004, 2005, 2008" },
    { title: "Green Channel Customs", desc: "High-priority clearance holder from BOI Sri Lanka.", year: "Active" },
  ...
  return (
    <div className="w-full bg-[#f8f9fa] flex flex-col min-h-screen selection:bg-brand-primary selection:text-white">
      ...
      <main className="flex-1 w-full bg-[#f8f9fa] px-[5px] pb-[5px] pt-[88px] sm:pt-[96px]" id="main-content" role="main">
        <article
          className="relative w-full rounded-[32px] sm:rounded-[40px] md:rounded-[48px] bg-white shadow-[0_2px_40px_-15px_rgba(0,0,0,0.05),inset_0_2px_20px_rgba(255,255,255,0.8)] border border-black/[0.03] p-2 sm:p-4 md:p-6 overflow-hidden min-h-[85vh]"
          aria-label="TOS Lanka Certifications & Quality Standards"
        >
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 max-w-4xl flex flex-col items-center">
                  <motion.div 
                    ...
                    role="status"
                    aria-label="Page category: Global Standards & Compliance"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-[5px] sm:gap-4 shrink-0 mt-2 sm:mt-0">
                ...
                >
                  <div className="flex items-center gap-5 mb-10">
                    ...
                    <div>
                      <h2 id="iso-heading" className="text-3xl md:text-4xl font-medium tracking-tight text-black font-heading leading-tight">
                        ISO Accreditations
                      </h2>
                      <div className="w-12 h-1 bg-brand-tertiary mt-3 rounded-full" aria-hidden="true" />
                    </div>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12" role="list" aria-label="ISO certifications">
                    {[
                      ...
                      <motion.div 
                        ...
                        role="listitem"
                      >
                         <div className="text-[10px] text-black/40 font-mono tracking-widest mb-3" aria-label={`Certification year: ${cert.year}`}>{cert.year}</div>
                         <div>
                  ...
                  <div className="mt-auto bg-white border border-black/[0.05] shadow-[inset_0_2px_15px_rgba(0,0,0,0.02)] p-8 rounded-[2rem] flex flex-col gap-6 relative overflow-hidden">
                     <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-brand-tertiary/[0.02] blur-[50px] pointer-events-none rounded-full" aria-hidden="true" />
                     
                     <div className="flex items-center gap-4 relative z-10">
                       <ScopeIcon className="w-6 h-6 text-brand-tertiary" />
                       <span className="text-[11px] md:text-xs font-bold tracking-[0.2em] text-black/80 uppercase" id="scope-heading">Approved Scope of Operations</span>
                     </div>
                     
                     <div className="h-[1px] w-full bg-black/5 relative z-10" aria-hidden="true" />
                     ...
                     <motion.ul 
                       ...
                       className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 relative z-10 list-none p-0 m-0"
                       aria-labelledby="scope-heading"
                     >
                       {scopeItems.slice(0, 6).map((item, idx) => (
                         <motion.li variants={listItemVariants} key={idx} className="flex items-start gap-4 group cursor-default">
                           <div className="relative w-6 h-6 mt-[2px] rounded-full border border-black/10 flex items-center justify-center shrink-0 group-hover:border-brand-tertiary/30 transition-colors bg-[#f8f9fa]" aria-hidden="true">
                ...
                >
                  <figure className="relative w-full h-full flex-1 rounded-[1.5rem] lg:rounded-[2rem] overflow-hidden bg-[#f3f4f6] group shadow-inner m-0">
                    <Image 
                      src="/certificates/iso.webp" 
                      alt="TOS Lanka ISO 9001, ISO 14001, ISO 45001 certification documents issued by Bureau Veritas" 
                      fill
                      sizes="(max-width: 768px) 100vw, 50vw"
                      className="object-contain p-4 sm:p-6 object-center transform scale-100 group-hover:scale-[1.03] transition-transform duration-[1.5s] ease-[cubic-bezier(0.22,1,0.36,1)] filter mix-blend-multiply brightness-[0.95]"
                      priority
                    />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-[5px] sm:gap-4 shrink-0 mt-2 sm:mt-0">
                ...
                >
                  <figure className="relative w-full h-full flex-1 rounded-[1.5rem] lg:rounded-[2rem] overflow-hidden bg-[#f3f4f6] group shadow-inner m-0">
                    <Image 
                      ...
                      alt="NMRA (National Medicines Regulatory Authority) certificate approving TOS Lanka for medical device manufacturing" 
                      fill
                      sizes="(max-width: 768px) 100vw, 35vw"
                      className="object-contain p-4 sm:p-6 transform scale-100 group-hover:scale-[1.03] transition-transform duration-[1.5s] ease-[cubic-bezier(0.22,1,0.36,1)] filter mix-blend-multiply brightness-[0.95]"
                      loading="lazy"
                    />
                ...
                <motion.section
                  ...
                  aria-labelledby="nmra-heading"
                >
                  <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-brand-primary/[0.02] blur-[100px] pointer-events-none rounded-full" aria-hidden="true" />

                  <div className="w-20 h-20 rounded-2xl bg-brand-primary/5 border border-brand-primary/10 flex items-center justify-center mb-10 text-brand-primary shadow-sm" aria-hidden="true">
                    <NMRAIcon className="w-10 h-10" />
                  </div>

                  <h2 id="nmra-heading" className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight text-black mb-8 font-heading max-w-2xl leading-[1.05]" style={{ wordSpacing: '-0.02em', letterSpacing: '-0.02em' }}>
              ...
              >
                <div className="absolute top-0 right-1/4 w-[600px] h-[600px] rounded-full bg-brand-primary/[0.02] blur-[150px] pointer-events-none" aria-hidden="true" />

                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16 relative z-10">
                  <div className="max-w-4xl">
                    <h2 id="awards-heading" className="text-4xl md:text-5xl lg:text-7xl font-medium tracking-tight text-black mb-6 font-heading leading-tight" style={{ wordSpacing: '-0.02em', letterSpacing: '-0.02em' }}>
                      Awards & Recognition
                    </h2>
                ...
                >
                  {awards.map((award, idx) => (
                    <motion.div 
                       ...
                       key={idx} 
                       className="group relative flex flex-row items-center gap-6 py-8 px-6 lg:px-10 rounded-[1.5rem] bg-[#f8f9fa] border border-black/[0.04] hover:border-brand-primary/20 hover:shadow-[0_15px_30px_-10px_rgba(0,143,40,0.1)] transition-all duration-500 overflow-hidden cursor-default min-h-[160px]"
                       role="listitem"
                    >
                       {/* Animated Accent Edge on the Left */}
                       <div className="absolute top-0 left-0 w-1.5 h-full bg-black/[0.04] group-hover:bg-brand-primary transition-colors duration-500" aria-hidden="true" />

                       {award.image && (
                         <div className="relative w-24 h-32 md:w-28 md:h-36 overflow-hidden rounded-xl border border-black/5 shadow-[0_5px_15px_-5px_rgba(0,0,0,0.05)] shrink-0 bg-white group-hover:scale-105 transition-transform duration-500 hidden sm:block">
                           <Image src={`/about images/${award.image}`} alt={`${award.title} certificate`} fill sizes="120px" className="object-contain p-2 md:p-3" loading="lazy" />
                         </div>
                       )}

                       <div className="relative z-10 flex-1">
                         {/* Pill Badge */}
                         <div className="inline-block px-3 py-1 bg-white border border-black/5 text-black/50 font-mono text-[11px] font-bold tracking-widest rounded-full mb-4 group-hover:text-brand-primary group-hover:border-brand-primary/20 transition-colors duration-500 shadow-sm" aria-label={`Year: ${award.year}`}>
                           {award.year}
                         </div>
                         
                         {/* Title & Description */}
                         <h3 className={`text-xl md:text-2xl font-bold text-black mb-2 font-heading tracking-tight group-hover:text-brand-primary transition-colors duration-500 ${!award.image && "pr-10"}`}>
                           {award.title}
                         </h3>
                         <p className={`text-[14px] md:text-[15px] text-black/60 font-medium group-hover:text-black/80 transition-colors duration-500 ${!award.image && "pr-8 lg:pr-12"}`}>
                           {award.desc}
                         </p>
                       </div>
                    </motion.div>
