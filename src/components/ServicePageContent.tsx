          ...
          <div className="w-full h-full max-w-[1400px] mx-auto relative z-10 px-0">
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-[5px] sm:gap-4">
                ...
                <motion.div
                  variants={itemVariants}
                  className="lg:col-span-5 bg-white rounded-[2rem] lg:rounded-[3rem] p-4 lg:p-5 border border-black/[0.03] shadow-[0_2px_20px_-10px_rgba(0,0,0,0.03)] relative overflow-hidden flex flex-col min-h-[400px] lg:min-h-[550px]"
                >
              ...
              >
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-tertiary/[0.02] blur-[120px] pointer-events-none rounded-full" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5 relative z-10">
                  {service.capabilities.map((cap, idx) => (
                    ...
                    >
                      {/* Left accent */}
                      <div className="absolute top-0 left-0 w-1 h-full bg-black/[0.04] group-hover:bg-brand-primary transition-colors duration-500 rounded-r-full" />

                      <div className="relative z-10">
                        {/* Number */}
                        <div className="inline-block px-3 py-1 bg-white border border-black/5 text-black/40 font-mono text-[11px] font-bold tracking-widest rounded-full mb-5 group-hover:text-brand-primary group-hover:border-brand-primary/20 transition-colors duration-500 shadow-sm">
                          0{idx + 1}
                        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-[5px] sm:gap-4 mt-0.5 sm:mt-0">
                ...
                >
                  <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-brand-tertiary/[0.02] blur-[120px] pointer-events-none rounded-full" />
                  ...
                  <div className="flex flex-col gap-3 relative z-10 flex-1">
                    {relatedServices.map((rs) => (
                      ...
                      >
                        ...
                        <ArrowUpRight className="w-5 h-5 text-black/20 group-hover:text-brand-tertiary group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300" />
                      </Link>
                    ))}
                  </div>
